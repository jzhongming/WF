package com.github.jzhongming.wf.mvc.beat.client.upload;
		...
		for (FileItem fileItem : fileItems) {
			if (fileItem.isFormField()) {
				...
				if (logger.isDebugEnabled()) {
					logger.debug("Found multipart file [" + file.getName() + "] of size " + file.getSize() + " bytes with original filename [" + file.getOriginalFilename() + "], stored "
